...
const COPY: Record<Locale, { eyebrow: string; title: string; sub: string; features: [Feature, Feature, Feature, Feature, Feature, Feature] }> = {
  fr: {
    ...
    features: [
      ...
      { icon: "pin", title: "Pin-to-Ride", desc: "Tape l'icône pin, déplace la map, confirme la cible." },
  ...
  en: {
    ...
    features: [
      ...
      { icon: "pin", title: "Pin-to-Ride", desc: "Tap the pin icon, pan the map, confirm the target." },
  ...
  es: {
    ...
    features: [
      ...
      { icon: "pin", title: "Pin-to-Ride", desc: "Toca el icono pin, mueve el mapa, confirma el destino." },
  ...
  de: {
    ...
    features: [
      ...
      { icon: "pin", title: "Pin-to-Ride", desc: "Pin-Icon tippen, Karte bewegen, Ziel bestätigen." },
  ...
  it: {
    ...
    features: [
      ...
      { icon: "pin", title: "Pin-to-Ride", desc: "Tocca l'icona pin, sposta la mappa, conferma il target." },
  ...
  pt: {
    ...
    features: [
      ...
      { icon: "pin", title: "Pin-to-Ride", desc: "Toque no ícone pin, mova o mapa, confirme o alvo." },
